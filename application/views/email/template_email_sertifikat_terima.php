              ...
              <tr>
                <td class="wrapper">
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        <h1 class="heading_text">Selamat, Proses registrasi sertifikat produk Anda diterima</h1>
                        <p>Sertifikat bisa Anda lihat pada halaman profile akun Anda pada situs thriftex.id. </p>
                        <br>
                        <br>
                        <p>Terima Kasih,</p>
                        <p>thriftex.id</p>
